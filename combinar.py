...
ruta_destino = r"C:\Personal Local\Recuperacion\Escuela\5to Semestre\Machine Learning\depht cameras\MultipleCameras\captured_data"+ "/" + categoria

base_ruta =  r"C:\Personal Local\Recuperacion\Escuela\5to Semestre\Machine Learning\depht cameras\MultipleCameras\captured_data" + "/" + categoria +"/raw_data"


 
# Prefijo para los nombres de los archivos de resumen
prefijo_resumen = "captura"
...
for idx, ruta in enumerate(subcarpetas, start=1):
    ...
    for archivo in archivos:
        ...
        if df.shape[1] == 4 and df.shape[0] == 33:
